...
def generate_pdf():
    ...
    pdf.cell(0, 15, title_text, new_x="LMARGIN", new_y="NEXT", fill=True, align='C')
    ...
    pdf.cell(0, 8, f'Date: {now}', new_x="LMARGIN", new_y="NEXT", align='C')
    pdf.ln(10)
    ...
    pdf.set_text_color(120, 120, 120)
    pdf.cell(0, 6, 'Generated by: Diego Torrez', new_x="LMARGIN", new_y="NEXT", align='C')
